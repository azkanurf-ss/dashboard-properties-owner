...
import { PropertiesParams, PropertiesFilterParams } from '../../pages/list-properties'
import { typeOptions, styleOption, localityOption } from '../../../constants/properties-api-params'
...
const ModalSortAndFilter = ({
  ...
  return (
    <>
      ...
      <CutomModalWrapper>
        <Modal isOpen={isModalOpen} onModalClose={() => setIsModalOpen(!isModalOpen)}>
          <div className="">
            <section>
              <div>
                ...
                <div className="el-grid">
                  ...
                  <InputGroup>
                    <Input id="maxPrice" className="el-col-split" type="number" />
