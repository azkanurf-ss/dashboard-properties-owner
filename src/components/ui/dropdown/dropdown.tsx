...
export const Dropdown = () => {
  ...
  return (
    <DropdownWrapper>
      <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}>sort&filter</button>
      <DropdownContent display={isDropdownOpen ? 'block' : 'none'} ref={ref} width={DDWidth}></DropdownContent>
    </DropdownWrapper>
  )
}
