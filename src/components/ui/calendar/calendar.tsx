...
import { CreateAppointmentModel, NegotiatorModel } from '@reapit/foundations-ts-definitions'
...
const CalendarAppointment = ({
  ...
  setModalCalendar,
  setNegotiatorsId,
  appointment: { data, isLoading, isError },
  negotiators,
}) => {
  ...
  return (
    <SnackProvider>
      <Modal isOpen={modalCalendar.isOpen} onModalClose={onModalClose} title="Check and Create Appointment">
        {isLoading || isError ? (
      ...
      <Modal isOpen={modalInfoEvent} onModalClose={() => setModalInfoEvent(false)} title="Event Details">
