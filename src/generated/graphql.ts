...
export type NegotiatorByOfficeQueryVariables = Exact<{
  OfficeId?: InputMaybe<Array<Scalars['String']> | Scalars['String']>
}>

export type NegotiatorByOfficeQuery = {
  __typename?: 'Query'
  GetNegotiators: {
    __typename?: 'PagedResultNegotiatorModel'
  ...
  GetProperties: {
    ...
    _embedded?:
      | Array<{
          ...
          selling?: { __typename?: 'PropertyModelSelling'; price?: number | null | undefined } | null | undefined
          address?:
            | {
                __typename?: 'PropertyModelAddress'
...
export const NegotiatorByOfficeDocument = `
    query NegotiatorByOffice($OfficeId: [String!]) {
  GetNegotiators(officeId: $OfficeId) {
    ...
    `
export const useNegotiatorByOfficeQuery = <TData = NegotiatorByOfficeQuery, TError = unknown>(
  client: GraphQLClient,
  variables?: NegotiatorByOfficeQueryVariables,
  options?: UseQueryOptions<NegotiatorByOfficeQuery, TError, TData>,
  headers?: RequestInit['headers'],
) =>
  useQuery<NegotiatorByOfficeQuery, TError, TData>(
    variables === undefined ? ['NegotiatorByOffice'] : ['NegotiatorByOffice', variables],
    fetcher<NegotiatorByOfficeQuery, NegotiatorByOfficeQueryVariables>(
      client,
      NegotiatorByOfficeDocument,
      variables,
      headers,
    ),
    options,
...
export const GetAllPropertiesDocument = `
  ...
  GetProperties(pageSize: 5) {
    ...
    `
export const useGetAllPropertiesQuery = <TData = GetAllPropertiesQuery, TError = unknown>(
  client: GraphQLClient,
